# [ISCAS 2025] TWavefussion: Wavelet-based Diffusion with Transformer for Multivariate Time Series Anomaly Detection 
...
> CUDA_VISIBLE_DEVICES={gpu_id} python main.py  --config test.yml  --doc ./{dataset}  --sequence --dataset PSM

For example: CUDA_VISIBLE_DEVICES=0 python main.py  --config test.yml  --doc ./PSM  --sequence --dataset PSM
...
## Citation
Hongjun Sheng, Xinggan Peng, Van Kwan Zhi Koh, Bihan Wen and Zhiping Lin, "TWavefussion: Wavelet-based Diffusion with Transformer for Multivariate Time Series Anomaly Detection", IEEE International Symposium on Circuits and Systems (ISCAS) 2025. [Link](https://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=11043617).

## Contact
HSHENG002@e.ntu.edu.sg
