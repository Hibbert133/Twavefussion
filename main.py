...
def parse_args_and_config():
    ...
    parser.add_argument( "--sample_type",type=str,default="ddim",help="sampling approach (generalized or ddpm_noisy)",)
    parser.add_argument("--skip_type",type=str,default="uniform",help="skip according to (uniform or quadratic)",)
    parser.add_argument( "--dataset",type=str,default='PSM',)#WADI SWAT SMAP. You can modify this property to change the data set.help='data choice'
